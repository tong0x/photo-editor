...
def visDerivatives(I_gray, Mag, Magx, Magy):
  ...
  Ax0.imshow(Mag, cmap='hot', interpolation='nearest')
  Ax0.axis('off')
  Ax0.set_title('Gradient Magnitude')

  Ax1.imshow(Magx, cmap='hot', interpolation='nearest')
  Ax1.axis('off')
  Ax1.set_title('Gradient Magnitude (x axis)')
  
  Ax2.imshow(Magy, cmap='hot', interpolation='nearest')
  Ax2.axis('off')
  ...
  Ax3.imshow(I_gray, cmap='hot', interpolation='nearest')
  Ax3.axis('off')
